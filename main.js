...
function refresh(estimatedVerbType) {
    ...
    if (estimatedVerbType == 1) {
        ...
        if (word == 'いく' || word == '行く') {
            ...
            else if (after == 'る' || after == 'う' || after == 'つ') words[3].innerText = front + 'った'
            ...
            else if (after == 'る' || after == 'う' || after == 'つ') words[4].innerText = front + 'って'
        ...
        if (word == 'くれる') {
            ...
            words[9].innerText = words[0].innerText + 'よう'
